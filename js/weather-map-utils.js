function adjustForTimezone(theOffset) {
    console.log('The timezone offset is: ' + theOffset);
    let now = new Date();
    console.log('The current time is below:');
    console.log(now);
    now.setMinutes(now.getMinutes() + theOffset);
    console.log('Adjusted current date to timezone offset below:');
    console.log(now);
    return now
}
